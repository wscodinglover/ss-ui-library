...
| `[修改]`switcherIcon | `[仅适用antd图标]`自定义树节点的展开/折叠图标 | React.ReactElement | - | 3.12.0 |
| `[新增]`basicSwitcherIcon | `[仅适用ss_lib图标]`自定义树节点的展开/折叠图标 | object{open: ReactNode, close: ReactNode} | - | 3.12.0 |
