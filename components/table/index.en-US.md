...
| `[废弃]`bordered | `[备注：暂定为true]` 是否展示外边框和列边框 | boolean | true |
...
| `[废弃]`pagination | `[备注：暂定为false]`分页器，参考[配置项](#pagination)或 [pagination](/components/pagination/) 文档，设为 false 时不展示和进行分页 | object | - |
