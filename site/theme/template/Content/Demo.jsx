...
class Demo extends React.Component {
  ...
  render() {
    ...
    const prefillStyle = `@import 'ss-ui-library/dist/ss-ui-library.css';\n\n${style ||
  ...
  var mountNode = document.getElementById('container');
    ...
    const codepenPrefillConfig = {
      ...
      js: sourceCode
        ...
        .replace(
          /import\s+\{\s+(.*)\s+\}\s+from\s+'ss-ui-library';/,
          "const { $1 } = window['ss-ui-library'];",
        )
      ...
      css_external: [
        ...
        'https://unpkg.com/ss-ui-library/dist/ss-ui-library.css',
      ],
      js_external: [
        ...
        'ss-ui-library/dist/ss-ui-library-with-locales.js',
    ...
    const dependencies = sourceCode.split('\n').reduce(
      ...
      { react: 'latest', 'react-dom': 'latest', antd: '3.x', 'ss-ui-library': 'latest' },
    );
