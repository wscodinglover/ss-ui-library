...
export default function Page1() {
  return (
    <ScrollOverPack id="page1" className="content-wrapper">
      ...
      {/*        <span className="token function">install</span> ss-ui-library --save*/}
      {/*      </code>*/}
      {/*    </pre>*/}
      {/*    <pre className="language-bash">*/}
      {/*      <code>$ yarn add ss-ui-library</code>*/}
      {/*    </pre>*/}
      {/*    <h3 id="引入样式">*/}
      {/*      <span>引入样式</span>*/}
      ...
      {/*    </h3>*/}
      {/*    <p>*/}
      {/*      在<code>ss-ui-library/dist</code> 目录下提供了{' '}*/}
      {/*      <code>ss-ui-library.less</code>等。*/}
      {/*    </p>*/}
      {/*    <h3 id="按需加载">*/}
      {/*      <span>按需加载</span>*/}
      ...
      {/*        <span className="token string">ss-ui-library</span>*/}
      {/*        <span className="token punctuation">;</span>*/}
      {/*      </code>*/}
      {/*    </pre>*/}
      {/*    <pre className="language-jsx">*/}
      ...
      {/*        <span className="token keyword">from</span>{' '}*/}
      {/*        <span className="token string">ss-ui-library/lib/star</span>*/}
      {/*        <span className="token punctuation">;</span>*/}
      {/*      </code>*/}
      {/*    </pre>*/}
      {/*  </section>*/}
